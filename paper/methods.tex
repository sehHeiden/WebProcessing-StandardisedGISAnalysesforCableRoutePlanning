...
\begin{table}[h!]
	...
	\end{tabular}
\end{table}
The completed list of layers and the processing applied to them, can be found in \textbf{Supplement S1}.
...
\begin{figure}
	...
	\subfloat[\centering Cost Raster.]{{\includegraphics[width=.45\linewidth]{./images/CostRasterExample.png} }}%
	\qquad
	\subfloat[\centering Aggregated Cost Raster.]{{\includegraphics[width=.45\linewidth]{./images/AggregatedCosts.png} }}%
	\qquad
	\subfloat[\centering Least Cost Path.]{{\includegraphics[width=.45\linewidth]{./images/LeastCostPathExample.png} }}%
